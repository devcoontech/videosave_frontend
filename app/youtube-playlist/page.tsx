...
export default function YoutubePlaylistPage() {
  ...
  return (
    <div className="space-y-16 py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Maintenance Notice for YouTube Playlist */}
      <div className="bg-amber-500/10 border border-amber-500/30 rounded-3xl p-8 text-center space-y-3 max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-amber-600 dark:text-amber-400">
          YouTube Playlist Downloader Under Maintenance
        </h2>
        <p className="text-sm text-slate-600 dark:text-zinc-300 max-w-xl mx-auto">
          We are currently updating our playlist engine for enhanced batch downloading performance. Please use our <strong>Instagram</strong>, <strong>Facebook</strong>, or <strong>TikTok</strong> downloader in the meantime!
        </p>
      </div>
