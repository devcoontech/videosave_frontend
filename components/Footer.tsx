...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-auto border-t border-slate-200 dark:border-[#1E2438] bg-white dark:bg-[#090A0F] transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-zinc-400 max-w-sm leading-relaxed font-medium">
              Free online video downloader. Save 4K, 1080p videos, and MP3 audio from TikTok, Instagram, Facebook, X (Twitter), Vimeo, and Dailymotion instantly.
            </p>
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-[#1E2438] flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 dark:text-zinc-400 gap-4">
          <div>
            © {new Date().getFullYear()} VideoSave Media Downloader (videosave.site). All rights reserved.
          </div>
          
          <div className="flex items-center gap-1.5 text-slate-700 dark:text-zinc-300 font-semibold bg-slate-100 dark:bg-[#11131F] px-3.5 py-1 rounded-full border border-slate-200 dark:border-[#1E2438]">
